        ...
        <div class="container-fluid">
            <div class="me-5">
                <a class="navbar-brand" href="{{ route('dashboard') }}">
                    <img src="/assets/img/tamsis.png" alt="Logo" width="60" height="54"
                        class="d-inline-block align-text-top">
                    <b class="fs-3">THAMSIS-STAR44</b>
                </a>
            </div>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="p-2"><a href="{{ route('actionlogout') }}"><button
                                        class="btn btn-outline-success" type="submit">Log Out</button></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
