...
@section('konten')
    <div class="container-fluid">
        <div class="text-end m-2"><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahproduk"> +
        ...
        <table class="table table-dark table-hover m-lg-2">
            ...
            @foreach ($produk as $p)
                <tr>
                    <td> {{ $p->kode }}<br><img src="/assets/img/{{ $p->gambar }}" alt="" width="80px"
                            height="100px"> </td>
                    <td> {{ $p->nama }} </td>
                    <td>Rp. {{ $p->harga }} </td>
                    <td> {{ $p->stok }} </td>
                    <td>
                        ...
                        <button class="btn btn-info" data-bs-toggle="modal"
                            data-bs-target="#ModalUpdateproduk{{ $p->kode }}">Update</button>
                        |
                        <button class="btn btn-danger" data-bs-toggle="modal"
                            data-bs-target="#ModalDeleteproduk{{ $p->kode }}">Delete</button>
                    </td>
                </tr>

                <!-- Ini tampil form update produk -->
                <div class="modal fade" id="ModalUpdateproduk{{ $p->kode }}" tabindex="-1"
                ...
                <div class="modal fade" id="ModalDeleteproduk{{ $p->kode }}" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
