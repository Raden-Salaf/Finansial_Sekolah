...
<body>
    ...
    justify-content-between">
            <div class="logo">
                <h1><a href="index.html">Tamansiswa 2 Jakarta</a> </h1> <!-- Uncomment below if
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">THAMSIS FINANCIAL-TECHNOLOGY</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Menjual berbagai kebutuhan sekolahmu:/</h2>
                    <div data-aos="fade-up" data-aos-delay="800">
                        <a href="/login" class="btn-get-started scrollto">Ayo Gabung</a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
                    <img src="assets/img/sekolah.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
        ...
        <section id="produk" class="portfolio">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-up">
                    <h2>Daftar Produk</h2>
                    <p>Cari Sesuai Keperluan anda :|</p>
                </div>
                    ...
                    @foreach ($produk as $p)
                        <div class="col-lg-4 col-md-6 portfolio-item {{ $p->nama }}">
                            <div class="portfolio-wrap">
                                <img src="assets/img/{{ $p->gambar }}" class="img-fluid" alt=""
                                    width="400px" height="600px">
                                <div class="portfolio-info">
                                    <h4>{{ $p->nama }}</h4>

                                    <div class="portfolio-links">
                                        <a href="assets/img/{{ $p->gambar }}" data-gallery="portfolioGallery"
                                            class="portfolio-lightbox" title="{{ $p->nama . ' ' }}"><i
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body clearfix">
                                        <div class="card" style="width: 18rem;">
                                            <img src="assets/img/{{ $p->gambar }}" class="card-img-top"
                                                alt="{{ $p->nama }}">
                                            <div class="card-body">
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 text-lg-left text-center">
                    <div class="copyright">
                        &copy; Copyright <strong>Abiyasa</strong>. All Rights Reserved
                    </div>
                    <div class="credits">
